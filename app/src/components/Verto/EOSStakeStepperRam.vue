                        ...
                        <q-tab-panel name="stake">
                            <div v-if="step >= 0" class="">
                                <q-stepper :dark="$store.state.settings.lightMode === 'true'" :light="$store.state.settings.lightMode === 'false'" v-model="step" vertical color="primary" animated flat>
                                            ...
                                            <div v-if="condition === 3" class="condition_3">
                                                <div class="text-black">
                                                    ...
                                                    <q-tabs
                                                        ...
                                                        <q-tab name="unstaking" label="Untaking" />
                                                        ...
                                                        <q-tab-panel :dark="$store.state.settings.lightMode === 'true'" :light="$store.state.settings.lightMode === 'false'" name="staking">
                                                            <div class="full-width">
                                                                <q-input :dark="$store.state.settings.lightMode === 'true'" :light="$store.state.settings.lightMode === 'false'" v-model="sendAmount" type="number" :suffix="'CPU' "  prefix="EOS" rounded outlined class="--input" @input="changeAmount()" />
                                                                <q-input  :dark="$store.state.settings.lightMode === 'true'" :light="$store.state.settings.lightMode === 'false'" v-model="sendAmountNet" type="number" :suffix="'NET' "  prefix="EOS" rounded outlined class="--input" @input="changeAmount()" />
                                                                <br>
                                                        ...
                                                        <q-tab-panel name="unstaking">
                                                            <div class="full-width">
                                                               <q-input :dark="$store.state.settings.lightMode === 'true'" :light="$store.state.settings.lightMode === 'false'" v-model="sendAmount" type="number" :suffix="'' "  prefix="EOS" rounded outlined class="--input" @input="changeAmount()" />
                                                                <q-input  :dark="$store.state.settings.lightMode === 'true'" :light="$store.state.settings.lightMode === 'false'" v-model="sendAmountNet" type="number" :suffix="'NET' "  prefix="EOS" rounded outlined class="--input" @input="sendAmountNet > currentAccount.amount ? sendAmountNet = currentAccount.amount : '' ; " />
                                                                <br>
                                    ...
                                    <q-step v-if="isPrivateKeyEncrypted" title="Sign & Submit" :name="2" prefix="2" :done="step > 2">
                                        ...
                                        <div class="text-black">
                                            ...
                                            <q-input v-model="privateKeyPassword" light rounded outlined class="--input" color="green" label="Private Key Password" debounce="500" :error="invalidPrivateKeyPassword" error-message="The password is incorrect" @input="checkPrivateKeyPassword()" :type="isPwd ? 'password' : 'text'">
                                                <template v-slot:append>
                                    ...
                                    <q-step title="Result" :name="4" prefix="3">
                                        ...
                                        <div v-if="spinnervisible" class="text-black">
                                            <q-spinner />
                                        </div>
                                        <div v-if="transactionStatus == 'Success'" class="content__success">
                                        ...
                                        <div v-else-if="error" class="content__failed text-red q-pa-md">
                                            ...
                                            <div class="text-h4 --subtitle text-center full-width --subtitle__transLink"> {{ error }}</div>
                                        </div>
  ...
  methods: {
    ...
    async sendStakingTransaction () {
      let transactionObject = {
        actions: [{
          account: 'eosio',
          name: this.action === 'staking' ? 'delegatebw' : 'undelegatebw',
          authorization: [{
            actor: this.currentAccount.name,
            permission: 'active'
          }],
          data: this.action === 'staking' ? {
