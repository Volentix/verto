    ...
    <div class="row flex justify-between q-pb-sm q-pt-sm">
        <div class="col col-8 flex items-center q-pl-md" style="min-height: 140px">
            ...
            <div class="call-action">
                <q-select light separator rounded outlined class="select-input" v-model="depositCoin" use-input @filter="filterDepositCoin" :disabled="!depositCoinOptions" :loading="!depositCoinOptions" :options="depositCoinOptions">
