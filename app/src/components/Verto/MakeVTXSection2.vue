    ...
    <div class="exchange-container">
        ...
        <div class="row items-end q-pa-md">
            <div class="col-6 p-desc">
              Make VTX while you sleep
            </div>
            <div class="col-6 flex justify-end q-pb-sm">
                <q-btn unelevated class="qbtn-start" color="black" @click="goToExchange" :text-color="$store.state.lightMode.lightMode === 'false' ? 'black':'white'" label="Buy with BTC/ ETH" />
            </div>
        </div>
    </div>
  </div>
