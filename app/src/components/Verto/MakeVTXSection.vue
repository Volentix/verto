...
export default {
  ...
  async created () {
    ...
    // // // console.loglog('highestVTXAccount highestVTXAccount highestVTXAccount highestVTXAccount highestVTXAccount', highestVTXAccount)
  ...
  methods: {
    async setHighestVTXAccount () {
      ...
      // // // console.loglog('this.highestVTXAccount **********************************', this.highestVTXAccount)
      if (this.highestVTXAccount !== undefined && this.highestVTXAccount !== null) {
        ...
        // // // console.loglog('this.estimatedReward --**', this.estimatedReward)
      ...
      // // // console.loglog('this.$store.state.highestVTXAccount.wallet > ', await this.$store.state.highestVTXAccount.wallet)
      }
    }
  }
}
