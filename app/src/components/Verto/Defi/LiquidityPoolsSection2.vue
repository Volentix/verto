    ...
    <div class="exchange-container">
      ...
      <div class="row items-end q-pa-md">
        ...
        <div class="col-6 flex justify-end q-pb-sm">
            <q-btn unelevated class="qbtn-start" color="black" @click="goToExchange" :text-color="$store.state.lightMode.lightMode === 'false' ? 'black':'white'" label="Add liquidity" />
        </div>
      </div>
    </div>
  </div>
