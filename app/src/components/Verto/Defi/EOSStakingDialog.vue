            ...
            <div class="col-12">
                ...
                <q-list separator>
                    ...
                    <q-item class="q-my-sm" clickable v-ripple>
                        ...
                        <q-item-section avatar>
                            <q-icon size="md" class="option--avatar" :name="'img:https://ndi.340wan.com/eos/'+ stakeData.contract0 +'-'+ stakeData.symbol0.toLowerCase() +'.png'" />
                        </q-item-section>
                    ...
                    <q-item class="q-my-sm" clickable v-ripple>
                        <q-item-section avatar>
                            <q-icon size="md" class="option--avatar" :name="'img:https://ndi.340wan.com/eos/'+ stakeData.contract1 +'-'+ stakeData.symbol1.toLowerCase() +'.png'" />
                        </q-item-section>
