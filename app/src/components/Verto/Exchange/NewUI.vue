    ...
    <div class="block-contents">
        ...
        <div class="mainBlk active">
            <div class="middle-block">
                ...
                <div class="fromBlk">
                    <p><span>From</span></p>
                    <h5 class="drpn"><span><img src="https://tokens.1inch.exchange/0x6b175474e89094c44da98b954eedeac495271d0f.png" alt=""> DAI</span> <input type="text" readonly value="1"></h5>
                    <p><span>Dai Stablecoin</span> <span>~$1</span></p>
                </div>
                <div class="toBlk">
...
body.lighTheme .alert .content p, a {
    color: #000;
}
