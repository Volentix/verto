                    ...
                    <template v-slot:header>
                        ...
                        <q-item-section style="margin-left: -110px; margin-top: -10px;" class="q-pt-sm">
                            ...
                            <q-item-label class="row justify-left" caption style="margin-left: 38px; margin-top: -9px;">
                                ...
                                <div>To&nbsp; {{transaction.friendlyTo}} </div>
                            </q-item-label>

                        </q-item-section>
                    </template>
                    <q-card class="bg-grey-2" :class="{'text-black': $store.state.settings.lightMode === 'false', 'text-white': $store.state.settings.lightMode === 'true'}">
                        <q-separator />
                        <q-item>
                    ...
                    <template v-slot:header>
                        ...
                        <q-item-section style="margin-left: -110px; margin-top: -10px;" class="q-pt-sm">
                            ...
                            <q-item-label class="row justify-left" caption style="margin-left: 38px; margin-top: -9px;">
                                ...
                                <div>+{{transaction.subTransactions[1].amountFriendly}} {{transaction.subTransactions[1].symbol}} </div>
                            </q-item-label>
                    ...
                    <template v-slot:header>
                        ...
                        <q-item-section style="margin-left: -110px; margin-top: -10px;" class="q-pt-sm">
                            ...
                            <q-item-label class="row justify-left" caption style="margin-left: 38px; margin-top: -9px;" >
                                ...
                                <div >From {{transaction.friendlyFrom}}</div>
