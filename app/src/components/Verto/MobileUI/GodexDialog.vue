              ...
              <div class="block-contents">
                ...
                <div class="mainBlk active">
                    <div class="middle-block">
                        ...
                        <div class="fromBlk">
                            <p><span>From</span></p>
                            <h5 class="drpn"><span><img src="https://tokens.1inch.exchange/0x6b175474e89094c44da98b954eedeac495271d0f.png" alt=""> DAI</span> <input type="text" value="1"></h5>
                            <p><span>Dai Stablecoin ~$1</span> <span>454545</span></p>
                        </div>
                        <div class="toBlk">
                            <div class="top_arrow_icon"><svg xmlns="http://www.w3.org/2000/svg" id="swap-direction-arrow" width="12" height="11" viewBox="0 0 12 11" fill="none"><path d="M6 1L6 10M6 10L11 5M6 10L1 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></div>
                            <p><span>To (estimated)</span> <span>Balance: 0.00</span></p>
                            <h5 class="drpn"><span><img src="https://tokens.1inch.exchange/0x6b175474e89094c44da98b954eedeac495271d0f.png" alt=""> ETH</span></h5>
                            <div class="cash-blk primari active">
                                <h5><b>1inch <span>Tx cost 0.0336E (~$123.74)</span></b> <b>0.00031 <span>~$1.18</span></b></h5>
                            </div>
                            <div class="cash-blk">
                            ...
                            <div class="cash-blk last_ops hide">
                                <h5><b class="dn_arr">OTC <span>Tx cost 0.0336E (~$123.74)</span></b> <b>0.00031 <span>~$1.18</span></b></h5>
                            </div>
                        </div>
                        <button type="button" class="theme-btn">Connect Wallet</button>
                    </div>
                    <ul class="rates">
                        <li>
                            <span>Rate</span>
                ...
                <div class="searchBlk">
                    <h5 class="heading"> <button type="button" class="backfromtoken"><span class="arrow"></span></button> Select a token</h5>
                    <form>
                        ...
                        <input type="text" placeholder="Search by name or paste address">
                    </form>
                    <ul class="cryptoSuggestions">
                        <li><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> ETH</li>
                        <li><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> ETH</li>
                        <li><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> ETH</li>
                        <li><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> ETH</li>
                        <li><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> ETH</li>
                    ...
                    <div class="cryptoList">
                        <ul>
                            <li>
                                <div class="leftBlk"><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> <p>Ethereum <span>ETHE</span></p></div> <b>0</b>
                            </li>
                            <li>
                                <div class="leftBlk"><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""> <p>Ethereum <span>ETHE</span></p></div> <b>0</b>
                            </li>
                ...
                <div class="settings">
                    <h5 class="heading">
                        <button type="button" class="backfromsetting"><span class="arrow"></span></button> Select a token
                    ...
                    <div class="settingList">
                        ...
                        <div class="settingRightOps">
                            <a href="#">65 <span class="rightDf"><span class="arrow"></span></span></a>
                        </div>
                    </div>
                    <div class="settingList">
                        <div class="settingTitle">
                        ...
                        <div class="settingRightOps">
                            <a href="#">0 <span class="rightDf"><span class="arrow"></span></span></a>
                        </div>
                    </div>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="rtBlk">
                                ...
                                <p><a href="#">Sushiswap</a><span>100%</span></p>
                            </div>
                            <span class="arrow"></span>
                        </li>
                        <li><img src="https://tokens.1inch.exchange/0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.png" alt=""></li>
...
function CashSelect () {
  console.log('cashSelector called ...... ')
...
function fnccc () {
  ...
  if (localStorage.getItem('theme')) {
    ...
    if (theme == 'dark') {
      ...
      rootCss.style.setProperty('--backgroundColor', '#131823')
...
// While the page will be loaded then the function will run
