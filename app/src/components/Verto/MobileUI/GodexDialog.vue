<template>
  <div class="lighTheme" style="background-color: white !important; margin-top:5px;" >
    <q-header class="bg-white" v-show="showHeader">
      <q-toolbar  class="text-black " v-if="$q.platform.is.mobile" style="margin-left: 10px;">
    ...
    <div class="block-contents">
        ...
        <br><br> -->
        <!-- <div class="text-black">depositCoin=={{depositCoin}}...... </div>
        <div class="text-black">Destination=={{destinationCoin}}...... </div> -->
            ...
            <div class="middle-block" >
              <div class="blk-header">
                ...
                <ul>
                    ...
                    <li class="settingBtn" @click="showHeader = false">
              ...
              <div class="fromBlk">
                  <p style="color:#6c86ad;"><span>From</span></p>
                  <h5 class="drpn" @click="coinStatus = 'deposit' ; showHeader = false; "><span><img :src="depositCoin.image" alt=""> {{depositCoin.value.toUpperCase()}}  </span> <input type="text"  v-model="swapData.fromAmount" @input="getSwapInfo()"></h5>
              ...
              <div class="toBlk">
                  ...
                  <div class="cash-blk last_ops hide" v-for="(path, index) in paths" :key="index">
              ...
              <button type="button" class="theme-btn" @click="openWallet()" :disabled="paths.length < 1">Connect Wallet</button>
            </div>
            <ul class="rates">
              <li>
                  <span>Rate</span>
        ...
        <div class="searchBlk">
          ...
          <ul class="cryptoSuggestions" v-if="coinStatus == 'deposit'">
              <li v-for="item in [...depositCoinOptions].sort((a,b) => b-a).slice(0,5)" :key="`${Math.floor(Math.random() * 1000)} ${item.address}`" @click="selectionProcess(item)">
        ...
        <q-card class=" text-black" style="background: #f2f2f2 !important" >
            ...
            <q-card-section class="q-mt-md">
              <q-splitter
                ...
                v-if="step == 1"
                style="background-color: white !important; height: 70vh;"
              >
                ...
                <template v-slot:after>
                  ...
                  >
                    <q-tab-panel name="deposit" style="padding: 10px;">
                      <q-item-label
                    ...
                    <q-tab-panel name="destination" class="q-pa-md">
