    ...
    <div class="container">
          ...
          <q-btn @click="wrongNetworkPopup = true" color="white" outline unelevated class="account-bar q-pl-none" no-caps rounded text-color="white">
            <div class="row items-center account-bar_row">
              ...
              <div class="col flex account-address items-center justify-between q-mr-lg">
                <span class="short-address q-mr-md">0x8e6b...12e2</span>
                <span class="identicon" v-html="avatar(accountAddress)" />
              </div>
            </div>
          </q-btn>
          <q-btn color="white" class="connect-wallet q-ml-md q-mr-md" no-caps text-color="white" outline rounded label="My holdings" />
      ...
      <div v-else class="row mobile-version-wrapper">
        ...
        <div v-if="connected" class="col-9 flex justify-end items-center">
          ...
          <q-btn color="white" v-if="$q.screen.width >= 768" class="connect-wallet q-ml-md q-mr-md" no-caps text-color="white" outline rounded label="My holdings" />
          <q-btn-dropdown
            class="dropdown-wrapper-btn" :class="{'active': toggleActive}"
            rounded
            color="grey-6"
          ...
          >
            <div class="column no-wrap dropdown-content">
              <div class="column nav q-pa-md text-white">
                <router-link v-if="$q.screen.width < 768" to="/portfolio-summary" class="text-white">My holdings</router-link>
                <router-link to="/funds" class="text-white">Explore funds</router-link>
                <router-link to="/faq" class="text-white">FAQs</router-link>
              </div>
              <q-separator dark horizontal inset class="q-mx-none" />
