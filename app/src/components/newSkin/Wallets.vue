...
<div>
  <div class="wallets-wrapper">
    ...
    <div class="wallets-wrapper--list">
      <q-list bordered separator>
       ...
       <q-btn unelevated flat icon-right="keyboard_arrow_down" class="full-width wallets-wrapper--list__hide-wallets" color="white" text-color="black" label="Hide all wallets" />
    </div>
  </div>
</div>
</template>
