  ...
  <q-page class="text-black bg-white">
    <div class="standard-content">
      <div class="standard-content--body">
        <h2 class="standard-content--title">Create free account</h2>
        <div class="standard-content--body__img flex flex-center">
          <img src="statics/use_referral_bg.png" alt="">
        </div>
        <div class="standard-content--body__form">
          <div class="text-step flex justify-center items-center active"><b>1</b> Paste your referral link</div>
          <q-input rounded outlined color="purple" />
          <hr style="height: 20px;opacity:0;">
          <div class="text-step flex justify-center items-center active"><b>2</b> Enter your twitter handle</div>
          <q-input rounded outlined color="purple" />
          <hr style="height: 20px;opacity:0;">
          <div class="text-step flex justify-center items-center active"><b>3</b> Subscribe to our youtube</div>
          <q-input rounded outlined color="purple" />
        </div>
