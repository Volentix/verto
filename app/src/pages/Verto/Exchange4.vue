                        ...
                        <div v-if="pStep === 1" class="prototype">
                            ...
                            <div class="you-pay-body row items-center">
                              <div class="col col-12 pay-coin">
                                ...
                                <q-select
                                    ...
                                    options-cover
                                    stack-label
                                    class="receive-coin-select"
                                    popup-content-class="receive-coin-select-popup"
                              ...
                              <div class="col col-6 choose-coin">
                                <span class="cursor" @click="triggerPayCoinSelect">{{payCoin}} <q-icon name="keyboard_arrow_down" /></span>
                              </div>
                              <div class="col col-6">
                          ...
                          <div class="you-receive">
                            ...
                            <div class="you-receive-body row items-center">
                              <div class="col col-6 choose-coin"><span class="cursor" @click="triggerReceiveCoinSelect">{{receiveCoin}} <q-icon name="keyboard_arrow_down" /></span></div>
                              <div class="col col-6">
    ...
    getRate () {
      ...
      this.$axios.post(url + '/v2/rate',
        ...
        .then((response) => {
          ...
          self.fetchingRate = false
          // self.depositQuantity = 0
          // self.destinationQuantity = 0
      ...
      // this.$axios.get('https://coinswitch.co/proxy/b/api/v1/get-exchange-amount?from_currency=btc&to_currency=eth&amount=0.1')
      //   .then(rates => {
      //     console.log('rates', rates)
      //   })
        // https://coinswitch.co/proxy/b/api/v1/get-exchange-amount?from_currency=btc&to_currency=eth&amount=0.1
    },
