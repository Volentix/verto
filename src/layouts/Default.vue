  ...
  <q-layout view="hHh LpR lFf">
    <q-layout-header>
      <q-toolbar>
        ...
        <q-toolbar-title class="flex flex-center uppercase q-display-1" v-show="$store.state.currentwallet.wallet">
      ...
      <q-layout-drawer  side="left" v-model="optionsDrawer" content-class="row" v-if="hasCurrentWallet()" :width="170" >
        <div class="col-12 column bg-primary">
          <options-drawer/>
        </div>
      </q-layout-drawer>
      <q-layout-drawer side="right" v-model="langDrawer" content-class="row" :width="170">
        <div class="col-12 column bg-primary">
          <lang-drawer @click.native="langDrawer = false"/>
        </div>
      </q-layout-drawer>
      <q-layout-drawer overlay side="right" v-model="langDrawer" content-class="row" :width="170">
        <div class="col-12 column bg-primary">
          <lang-drawer @click.native="langDrawer = false"/>
        </div>
      </q-layout-drawer>
