    ...
    <q-card-main>
       <div class="text-center">
        <div class="logo-welcome">
         ...
         <div class="">
          <div class="">
            <q-field :error="passHasError" v-bind:error-label="$t('Welcome.incorrect')">
              <q-input
              type="password"
              dark
              v-model="password"
              color="green"
              @keyup.enter="login"
              :float-label="$t('Welcome.password')"
              @input="checkPassword"
              ref="psswrd"
            />
            </q-field>
  ...
  methods: {
    ...
    async destroyData () {
      try {
        ...
        this.$q.notify({type: 'positive', message: 'Config successfully deleted'})
