<template>
  <q-page  class="flex flex-center text-white bg-black">
    <q-card style="width:55rem;" flat>
      <q-card-main class="text-center text-white">
        <div class="text-center text-weight-bold uppercase q-pa-lg">
        ...
        >
          <q-tr  :id="props.row.id" slot="body" slot-scope="props" :props="props" class="cursor-pointer">
            <q-td
              ...
              :props="props"
            >
              <div v-if="col.name === 'name'" class="text-center uppercase text-white q-pa-lg">
      ...
      columns: [
        {
          ...
          align: 'center',
          sortable: false,
          classes: 'text-right q-display-2'
        }, {
          name: 'associations',
          label: 'Tools',
          required: false,
