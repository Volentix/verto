      ...
      <div v-show="navigation.mainpage">
        <q-card-title class="text-weight-bold text-center uppercase">
          <div>
            ...
            <big class="titillium q-pa-xl">Wallet</big>
        ...
        <q-card-main class="text-center">
          <div class="text-center text-weight-bold uppercase q-pa-md" >
            <div v-if="isEosWallet()" >
              ...
              <div class="row justify-center gutter-sm">
                <div class="float-left text-center q-ml-sm q-pa-xl">
                  <p class="q-display-2"> {{ balance }} </p>
                  <p class="q-subtitle">VTX Promise</p>
                </div>
                <div class="float-left text-center q-ml-sm  q-pa-xl">
                  <p class="q-display-2"> {{ vtxBalance }} </p>
                  <p class="q-subtitle">VTX Balance</p>
                </div>
                <div class="float-left text-center q-ml-sm  q-pa-xl">
                  <p class="q-display-2"> {{ eosBalance }} </p>
            ...
            <div v-else>
              <div class="row justify-center gutter-sm">
                <div class="float-left text-center q-ml-sm q-pa-xl">
                  <span class="q-display-2"> {{ balance }} </span>
...
export default {
  ...
  methods: {
    ...
    copyWalletKey () {
      ...
      this.$q.notify({type: 'positive', message: this.$t('DisplayKey.copied')})
    },
    truncate (text, len) {
