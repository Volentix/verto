<template>
  ...
  <div class="flex flex-center text-white bg-black">
      ...
      <div class="row items-center">
        <div v-if="transactionStatus === 'CANCELLED'">
          <q-table
            ...
            row-key="name"
          >
              <q-tr :id="props.row.id" slot="body" slot-scope="props" :props="props" class="q-display-1" @click.native="showTransactionDetails(props.row)">
                  <q-td
        ...
        <div v-if="transactionStatus === 'CONVERTED'">
          ...
          >
              <q-tr :id="props.row.id" slot="body" slot-scope="props" :props="props" class="cursor-pointer" @click.native="showTransactionDetails(props.row)">
                  ...
                  <div v-if="col.name === 'conversionCount'" class="q-headline">
                    ...
                    <div v-if="props.row.entry_path === 'manual'">
                      <countdown :time="props.row.timeremaining" :transform="transform" >
                        <template slot-scope="propsss">
                          <div >
                            <div v-if="propsss.totalDays > 0" class="q-headline" >
                              {{ propsss.days }} Days
                            </div>
    ...
    <q-modal v-model="activeTransaction" v-if="activeTransaction" content-classes="bg-dark" content-css="max-height: 90vh;" no-refocus>
      ...
      <div class="row gutter-sm q-pa-lg text-white" style="max-width: 550px; width: 100vw;">
        <q-list no-border dark class="full-width">
          ...
          <q-item>
            <q-item-main label="Native Currency:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Native Amount:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Conversion Rate:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Confirmations Count:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Ledger Transaction Id:" />
            <q-item-side right>
              <q-item-tile stamp>
          ...
          <q-item>
            <q-item-main label="Pre Bonus Vtx Amount:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Phase Bonus Vtx Amount:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Additional Bonus Vtx Amount:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Total Vtx Amount:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Conversion Time:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Confirmation Time:" />
            <q-item-side right>
          ...
          <q-item>
            <q-item-main label="Approved Time:" />
            <q-item-side right>
...
export default {
  ...
  methods: {
    ...
    copyLedgerId (address) {
      ...
      this.$q.notify({type: 'positive', message: 'Successfully copied ledger transaction id'})
    },
    truncate (text, len) {
