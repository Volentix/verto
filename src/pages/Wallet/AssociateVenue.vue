  ...
  <q-page class="flex flex-center text-white bg-black">
    <q-card flat>
      <q-card-title class="text-weight-bold text-center">
        ...
        <big class="titillium uppercase q-pa-lg">{{ $t('VenueAssignAddress.header') }}</big>
            ...
            <div class="text-center text-white uppercase">
              ...
              <q-field>
                <q-input
                  ...
                  color="greeen"
                  v-bind:float-label="$t('VenueAssignAddress.venue_username')"
                  @input="checkUsername"
            ...
            <div class="text-center text-white uppercase">
              ...
              <q-field>
                <q-input
                  ...
                  color="green"
                  v-bind:float-label="$t('VenueAssignAddress.venue_password')"
                  @input="checkVenuePassword"
                  @keyup.enter="gotoVertoPassword()"
                />
              </q-field>
              <div v-show="wrongCredentials" class="q-title uppercase text-red q-pa-md text-center">
                {{ $t('VenueAssignAddress.bad_credentials') }}
              </div>
              <div v-show="emailVerificationRequired" class="q-title uppercase text-red q-pa-md text-center">
                {{ $t('VenueAssignAddress.email_verification_required') }}
              </div>
              <div v-show="addressNotUnique" class="q-title uppercase text-red q-pa-md text-center">
                {{ $t('VenueAssignAddress.verto_address_not_unique') }}
              </div>
              <div v-show="userDeactivated" class="q-title uppercase text-red q-pa-md text-center">
                {{ $t('VenueAssignAddress.user_deactivated') }}
              </div>
              <div v-show="somethingwrong" class="q-title uppercase text-red q-pa-md text-center">
            ...
            <div class="text-center text-white uppercase">
              <q-field>
                <q-input
                  ...
                  color="green"
                  v-bind:float-label="$t('ChangeVertoPassword.current')"
