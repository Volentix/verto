  ...
  <q-card style="max-width: 700px;" flat>
    <div v-show="showMainSteps">
      <q-card-title class="text-weight-bold text-center uppercase">
        ...
        <q-stepper color="green bg-white" ref="stepper" alternative-labels :contractable="contractable">
          <!--
            1.Private key
            -->
          <q-step name="privatekey" title="Private Key" order="10" class=" bg-black workflow-step">
            <q-card-main class=" text-white"  >
              <div class="float-center text-center">
                <div class="q-py-sm uppercase">
                  <q-item>
                    <q-item-side>
                      <q-chip v-show="!eosKeyNext || eosKeyInvalid" dense color="red" class="shadow-1">&nbsp;</q-chip>
                      <q-chip v-show="eosKeyNext && !eosKeyInvalid" dense color="green" class="shadow-1">&nbsp;</q-chip>
                    </q-item-side>
                    <q-item-main label="A valid EOS active key" />
                  </q-item>
                </div>
                <div>
                  <q-field :count="51">
                    <q-input
                      ...
                      color="green"
                      :float-label="$t('EosAccount.enter_private_key')"
                    />
                  </q-field>
                </div>
                <div v-show="eosKeyInvalid" class="q-title uppercase text-red">
                  Key invalid
                </div>
          ...
          <!--
            2. Account Name
            -->
          <q-step default name="accountName" title="Account Name" order="20" class=" bg-black workflow-step">
            <q-card-main class=" text-white text-center"  >
              <div>
                <q-field >
                  <q-select
                    dark
                    stack-label="EOS Account Name"
                    color="green"
                    separator
          ...
          <!--
            ...
            -->
          <q-step default name="saveKeyEncrypted" title="Save Key" order="30" class=" bg-black workflow-step">
            <q-card-main class=" text-white text-center">
              <div class="q-display-1 q-pa-lg uppercase">
                Save Private Key
                <q-item>
                  <q-item-side>
                    <span class="q-pa-sm">
          ...
          <!--
            4. Verto Password
            -->
          <q-step default name="vertoPassword" title="Verto Password" order="40" class=" bg-black workflow-step">
            <q-card-main class=" text-white text-center"  >
              <div>
                <q-field >
                  <q-input
              ...
              <div v-show="incorrectPassword" class="q-title uppercase text-red q-pa-lg">
                {{ $t('Welcome.incorrect') }}
              </div>
              <div v-show="walletNameUsed" class="q-title uppercase text-red q-pa-lg">
                {{ $t('DisplayKey.name_is_used') }}
              </div>
              <div v-show="unknownError" class="q-title uppercase text-red q-pa-lg">
                Unknown Error
              </div>
    ...
    <div v-show="!showMainSteps">
      ...
      <q-stepper color="green bg-white" ref="stepperFilePassword" alternative-labels :contractable="contractable">
        <!--
          1.Private key
          -->
        <q-step default name="filePassword" title="File Password" class=" bg-black workflow-step">
          <q-card-main class=" text-white"  >
            <div class="float-center text-center">
                <div class="uppercase q-title q-pa-md">
                ...
                <span class="q-pa-sm">
                  <q-field >
                    <q-input
                      ...
                      color="green"
                      float-label="Password For The File"
        ...
        <!--
          2. Confirm
          -->
        <q-step name="filePasswordConfirm" title="Confiirm Password" class=" bg-black workflow-step">
          <q-card-main class=" text-white"  >
            <div class="float-center text-center">
              <div class="q-py-sm uppercase">
              </div>
                ...
                <span class="q-pa-sm">
                  <q-field >
                    <q-input
                      ...
                      color="green"
                      float-label="Confirm Password For The File"
        ...
        <!--
          ...
          -->
        <q-step name="saveFileInWallet" title="Save In Wallet" class=" bg-black workflow-step">
          <q-card-main class=" text-white"  >
            <div class="float-center text-center">
