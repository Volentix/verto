...
<q-page class="flex flex-center text-white bg-black">
  <q-card flat>
      ...
      <q-stepper dark color="green bg-white" ref="stepper" alternative-labels :contractable="contractable">
        <q-step default name="first" title="Select Config File" class=" bg-black workflow-step">
        ...
        <q-step  name="second" title="Verto Password" class=" bg-black workflow-step">
          <q-card-main class=" text-white text-center"  >
            <div>
              <q-field >
                <q-input
            ...
            <div v-show="fileEmpty" class="q-title uppercase text-red q-pa-lg">
    ...
    async restoreConfig () {
      ...
      reader.onload = async function () {
        try {
          ...
          that.$q.notify({ type: 'positive', message: 'Application refreshing' })
          setTimeout(function () {
