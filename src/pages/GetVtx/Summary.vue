<template>
  <q-page class="flex flex-center text-white bg-black">
    <q-card class="q-pa-sm" flat>
      <q-card-title class="text-weight-bold text-white text-center uppercase">
        <div class="float-center q-pa-sm">
          <q-icon class="float-left" name="help_outline" size="2.5rem" color="white" @click.native="$documentationManger.openDocumentation('getvtx/index')">
            <q-tooltip>{{ $t('SettingsView.help') }}</q-tooltip>
          </q-icon>
          <big class="titillium q-pa-xl">VTX TOKEN DISTRIBUTION</big>
          <q-icon class="float-right" name="close" size="2.5rem" color="white" @click.native="$router.push('/wallet')"/>
        </div>
        <div class="row">
          <span class="col text-center uppercase">
            ROUND
        ...
        <div class="float-center q-pa-sm" v-show='!venueIsAssociated'>
           <div class="q-pa-md" style='border-style: solid;'>
            ...
            <div class="q-pa-sm">
              <q-btn class=" q-mr-sm" outline color="white" v-close-overlay size="md" label="Yes" to="/associations" />
            </div>
          </div>
        </div>
      </q-card-title>
      <q-card-main v-if="data.current_round" class="text-center text-white">
        <div>
          <div v-if="walletStatus === 'crowdfund_over'" class="q-display-3 animate-blink text-red q-pa-sm" style='border-style: solid;'>
          ...
          <div v-show="walletStatus != 'crowdfund_over'">
            <div v-show="showGetVTX" class="q-pa-md" style='border-style: solid;'>
              ...
              <div v-show="walletStatus === 'wallet_not_whitelisted'">
                <div  class="q-pa-md q-title uppercase">
                ...
                <div class="q-mt-md q-mb-md">
                  <q-btn class=" q-mr-sm" outline color="white" v-close-overlay size="md" :label="$t('WalletManager.associations')" to="/associations" />
                </div>
              </div>
          ...
          <div class="row q-pa-lg">
            <span class="col text-center">
              <span class="q-display-1 text-yellow">
      ...
      <div style="padding: 50px" class="text-center bg-black text-white">
        ...
        <div class="q-pa-sm">
          <q-field
              ...
              :count="100"
            >
            <q-input dark type="password" v-model="vertopassword" :error="vertoPasswordEmpty" color="blue" v-bind:float-label="$t('CreateVertoPassword.vertopassword')"  />
            </q-field>
        </div>
        <div class="q-pa-sm">
          <div>
