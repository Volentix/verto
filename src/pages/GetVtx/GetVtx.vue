  ...
  <q-page class="flex flex-center text-white bg-black">
    <q-card class="q-pa-sm" style='' flat>
      <q-card-title class="text-weight-bold text-white text-center">
        <div class="float-center uppercase">
      ...
      <q-card-main class="text-left text-white text-black">
        <div class="full-width row gutter bg-white q-pa-lg" v-if="!doneCountdown">
          ...
          <div class="col text-left q-pa-sm">
            <q-list no-border>
              ...
              <q-item>
                <q-item-main class="row justify-between">
                  <div class="col">
                    <countdown :time="timeremaining" :transform="transform" class="q-headline">
