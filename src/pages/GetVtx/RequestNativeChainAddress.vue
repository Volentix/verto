    ...
    <q-card style="max-width: 500px;" flat>
      ...
      <q-stepper dark color="green bg-white" ref="stepper" alternative-labels :contractable="contractable">
        <q-step default name="first" title="Rules" class=" bg-black workflow-step">
          <q-card-main class="text-center text-white uppercase"  >
            <q-item>
              <q-item-side>
                <q-chip dense color="red" class="shadow-1">&nbsp;</q-chip>
              </q-item-side>
              <q-item-main :label="$t('RequestNativeChainAddress.second_p')" />
            </q-item>
            <q-item>
              <q-item-side>
                <q-chip dense color="red" class="shadow-1">&nbsp;</q-chip>
              </q-item-side>
              <q-item-main :label="$t('RequestNativeChainAddress.second_p_point_1')" />
            </q-item>
            <q-item>
              <q-item-side>
                <q-chip dense color="red" class="shadow-1">&nbsp;</q-chip>
              </q-item-side>
              <q-item-main :label="$t('RequestNativeChainAddress.third_p')" />
            </q-item>
            <div class="q-pa-md">
        ...
        <q-step name="second" title="Native Chain" class=" bg-black workflow-step">
          <q-card-main class="text-center text-white"  >
            <div class="q-pa-md">
                ...
                <div v-show="errors.noAddress" class="q-title uppercase text-red q-pa-md">
                  {{ $t('RequestNativeChainAddress.err_noAddressAvailable') }}
                </div>
                <div v-show="errors.transactionsExist" class="q-title uppercase text-red q-pa-md">
                  {{ $t('RequestNativeChainAddress.err_pendingTransactionsExist') }}
                </div>
                <div v-show="errors.mustWait" class="q-title uppercase text-red q-pa-md">
