<template>
  <div class="layout-padding">
    <q-modal v-model="showErrorModal" minimized>
    ...
    <q-modal v-model="blocktopusModal" ref="modalRef">
      <q-card class="q-pa-lg">
        ...
        <div class="q-mt-md q-mb-xl">
          <q-btn class="float-center q-mr-sm" color="grey-9" v-close-overlay size="md" :label="$t('AssociateView.create')" to="/blocktopusCreate" />
          <q-btn class="float-right" outline color="primary" v-close-overlay size="md" :label="$t('AssociateView.login')" to="/blocktopusAssociate" />
        </div>
      </q-card>
    </q-modal>
      ...
      <div class="flex justify-center">
        ...
        <q-card style="width: 23rem; border-style: solid;" class="justify-center q-pa-sm q-mb-sm" flat>
          <q-item class="full-width">
            <q-item-side style="padding-right: 20px;" avatar="statics/img/btc.png" />
            <div class="verticalLine full-width">
              <q-item-main class="full-width">
        ...
        <q-card style="width: 23rem; border-style: solid;" class="justify-center q-pa-sm q-mb-sm" flat>
          <q-item class="full-width">
            <q-item-side style="padding-right: 20px;" avatar="statics/img/crypto-coins-2.png" />
            <div class="verticalLine full-width">
              <q-item-main class="full-width">
